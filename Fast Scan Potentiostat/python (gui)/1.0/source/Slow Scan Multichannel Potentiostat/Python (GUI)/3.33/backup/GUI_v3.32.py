...
class MainUI(QtWidgets.QMainWindow):
    ...
    def open_dpv(self, file, df):
        ...
        if not failed:    
            ...
            self.dpv_data_item_list.append(pg.PlotDataItem(pen=pg.mkPen(color_str)))
    ...
    ##### DPASV PAGE CODE (NATHAN)  Uncoded #####
    ...
    def open_dpasv(self, file, df):
        ...
        if not failed:    
            ...
            self.dpasv_data_item_list.append(pg.PlotDataItem(pen=pg.mkPen(color_str)))
    ...
    def run_asv(self):
        ...
        command = "{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}".format(#self.channel_selector.text()
                                                                3,
    ...
    def reset_experiment_counters(self):
        ...
        counter_keys = ['cv_counter', 'dpv_counter', 'dpasv_counter']

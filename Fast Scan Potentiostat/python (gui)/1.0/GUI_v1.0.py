...
class MainUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # set window icon
        self.setWindowIcon(QIcon('./icons/fs.png'))
    ...
    def emit_update_signal_v(self):
            # Emit the signal when the button is clicked
            self.communicate.update_v.emit()
    def emit_update_signal_s(self):
            # Emit the signal when the button is clicked
            self.communicate.update_s.emit()
    ...
    # def test(self,type=0):
    #     label_style = {"font-size": "18pt"}
    #     if type:
    #         self.plot_widget_dpasv.setLabel('bottom', 'Voltage', units='V', **label_style)
    #     else:
    #         self.plot_widget_dpasv.setLabel('bottom', 'Time', units='s', **label_style)
    ...
    def auto_save(self):
        ...
        file_path = os.path.join(documents_path, 'Fast Scan Potentiostat', 'Auto Save', experiment, current_date, file_name)
        file_path_json = os.path.join(documents_path, 'Fast Scan Potentiostat', 'Auto Save', experiment, current_date, file_name_json)
...
def main():
    ...
    if sys.platform.startswith('win'):
        myappid = 'fraunhofer-usa.fast-scan-portable-potentiostat.gui.1.0'  # Arbitrary string

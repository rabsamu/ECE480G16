...
class AD5933 {
    public:
        ...
        static bool setSettlingCycles(int); // This isn't static in original library, why? It cannot be used outside of this class if not static.
		...
		static double twoPointCalibration(int start_freq, int freq_incr, double ref, int num_incr, double linear_gain[]);

		static bool calibrateAvg(double gain[], int ref, int n);
	private:
        // Private data

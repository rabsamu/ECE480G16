...
#define ADS1256_h
	...
	// Add Teensyduino Implimentation...
	// Define PORT
	#define PORT_DRDY GPIO9_DR // Pin 4 on Teensyduino
	#define PIN_DRDY GPIO9_PSR
	#define PINDEX_DRDY CORE_PIN4_BIT  
	#define DDR_DRDY GPIO9_GDIR

	#define PORT_CS GPIO9_DR // Pin 5 on Teensyduino
	#define PIN_CS GPIO9_PSR
	#define PINDEX_CS CORE_PIN5_BIT
	#define DDR_CS GPIO9_GDIR

	#define PORT_RESET GPIO7_DR // PIN 6 on Teensyduino
	#define PIN_REST GPIO7_PSR
	#define PINDEX_RESET CORE_PIN6_BIT
	#define DDR_RESET GPIO7_GDIR
